...
My first map attempt plotted study sites colored by radiance bin — but no standard basemap felt thematically coherent without drowning out the point colors. The solution: I overlaid study site coordinates directly onto **NASA's Black Marble night light imagery** [@nasa_worldview], which provided a real-data dark basemap. This let me show actual light pollution context while placing the radiance bins precisely where they were measured.
